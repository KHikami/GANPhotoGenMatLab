  ...
  methods
    ...
    function [layers_grad_weight, layers_grad_bias, grad_input] = bprop(this, ...
     ...
     function [cost, grad, grad_fake_image_batch ]= gan_discriminate(this, real_image_batch, ...
         ...
         [cost, grad] = eval_at(this, [real_image_batch;fake_image_batch], [ones(batch_size,1);zeros(batch_size,1)], param_vector);
...
%          grad = - grad;
     ...
     function [cost, grad]= gan_generate(this, ...
         ...
         % Recall that we want to minimize function of gan generator is 
         ...
         [cost, ~, grad_fake_image_batch] = eval_at(discriminator, fake_image_batch, zeros(batch_size,1));
